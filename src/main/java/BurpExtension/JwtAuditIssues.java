...
public abstract class JwtAuditIssues {
    ...
    public static AuditIssue expired(HttpRequestResponse baseRequestResponse, HttpRequestResponse checkRequestResponse){
    ...
    public static AuditIssue withoutSignature(HttpRequestResponse baseRequestResponse, HttpRequestResponse checkRequestResponse){
    ...
    public static AuditIssue getAlgNone(HttpRequestResponse baseRequestResponse, HttpRequestResponse checkRequestResponse){
    ...
    public static AuditIssue invalidSignature(HttpRequestResponse baseRequestResponse, HttpRequestResponse checkRequestResponse){
    ...
    public static AuditIssue emptyPassword(HttpRequestResponse baseRequestResponse, HttpRequestResponse checkRequestResponse){
    ...
    public static AuditIssue invalidEcdsa(HttpRequestResponse baseRequestResponse, HttpRequestResponse checkRequestResponse){
    ...
    public static AuditIssue jwksInjection(HttpRequestResponse baseRequestResponse, HttpRequestResponse checkRequestResponse){
