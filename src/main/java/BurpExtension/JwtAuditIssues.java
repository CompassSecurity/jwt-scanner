...
public abstract class JwtAuditIssues {
    ...
    public static AuditIssue withoutSignature(HttpRequestResponse baseRequestResponse, HttpRequestResponse markedRequestResponse, int confidence){
        return auditIssue("JWT Signature not required",
                ...
                baseRequestResponse.request().url(),
                AuditIssueSeverity.HIGH,
                setAuditIssueConfidence(confidence),
                null,
                null,
                AuditIssueSeverity.HIGH,
                markedRequestResponse);
    ...
    public static AuditIssue getAlgNone(HttpRequestResponse baseRequestResponse, HttpRequestResponse markedRequestResponse, int confidence){
    ...
    public static AuditIssue invalidSignature(HttpRequestResponse baseRequestResponse, HttpRequestResponse markedRequestResponse, int confidence){
    ...
    public static AuditIssue emptyPassword(HttpRequestResponse baseRequestResponse, HttpRequestResponse markedRequestResponse, int confidence){
    ...
    public static AuditIssue invalidEcdsa(HttpRequestResponse baseRequestResponse, HttpRequestResponse markedRequestResponse, int confidence){
    ...
    public static AuditIssue jwksInjection(HttpRequestResponse baseRequestResponse, HttpRequestResponse markedRequestResponse, int confidence){
    ...
    private static AuditIssueConfidence setAuditIssueConfidence (int confidence){
        if(confidence == 0) {
